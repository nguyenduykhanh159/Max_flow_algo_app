...
import entity.Edge;
import sample.MenuController.NodeFX;
...
public class RightClickMenu {
    ...
    public RightClickMenu() {
        ...
        Image openIcon = new Image(getClass().getResourceAsStream("/icon/delete_img.png"));
        ImageView openView = new ImageView(openIcon);
        delete.setGraphic(openView);

        Image textIcon = new Image(getClass().getResourceAsStream("/icon/rename_img.png"));
